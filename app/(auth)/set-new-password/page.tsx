...
export default function SetNewPasswordPage() {
  ...
  const passwordRequirements = [
    { text: "Minimum 8 Characters", met: newPassword.length >= 8 },
    { text: "At Least One Capital Letter", met: /[A-Z]/.test(newPassword) },
    { text: "At Least One Number", met: /\d/.test(newPassword) },
    { text: "At Least One Special Character (! @ # $ % &)", met: /[!@#$%&]/.test(newPassword) },
  ]
      ...
      <div className="max-w-md mx-auto pt-16 px-4">
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="flex items-center justify-between mb-8">
            <Link href="/otp-verification" className="flex items-center text-gray-600 hover:text-gray-800">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-sm">Just Create A New Password To Get Back Into Your Swagifyy Account.</p>
          </div>
